...
import com.udemycourses.workoutapp.databinding.ItemExerciseStatusBinding
       ...
       val model: ExerciseModel = items[position]
        ...
        when{
            ...
            model.getIsCompleted() -> {
                holder.tvItem.background = ContextCompat.getDrawable(holder.itemView.context, R.drawable.item_circular_green_color_accent_border)
            }
            else -> {
